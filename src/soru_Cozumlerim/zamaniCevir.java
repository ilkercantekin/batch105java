...
* Java dilini kullanarak, TimeConvert(num) methodunun kullanicidan integer veri tipinde num parametresini almasını sağlayın
  ...
  *
  * Saat ve dakika sayısını iki nokta üst üste ile ayırın. Ornegin giris 126 ise output 2:6 seklinde olmalidi
     */
    ...
    public static String zaman(int ti){
        ...
        return saat + ":" + min;
        /*
        Kullanici sayilarla beraber harfler ve ozel karakterler de girse
        mesela 12sdsd64654#$%^& gibi yine de methodun calismasini saglayabilir misin
         */
    }
